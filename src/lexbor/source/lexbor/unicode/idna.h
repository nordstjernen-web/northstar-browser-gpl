...
typedef enum {
    ...
    LXB_UNICODE_IDNA_FLAG_CHECK_BIDI              = 1 << 3,
    LXB_UNICODE_IDNA_FLAG_CHECK_JOINERS           = 1 << 4,
...
typedef struct {
    ...
    lxb_unicode_normalizer_t nfc_check;
}
lxb_unicode_idna_t;

typedef enum {
    LXB_UNICODE_IDNA_BIDI_OTHER = 0x00,
    LXB_UNICODE_IDNA_BIDI_L     = 0x01,
    LXB_UNICODE_IDNA_BIDI_R     = 0x02,
    LXB_UNICODE_IDNA_BIDI_AL    = 0x03,
    LXB_UNICODE_IDNA_BIDI_AN    = 0x04,
    LXB_UNICODE_IDNA_BIDI_EN    = 0x05,
    LXB_UNICODE_IDNA_BIDI_ES    = 0x06,
    LXB_UNICODE_IDNA_BIDI_CS    = 0x07,
    LXB_UNICODE_IDNA_BIDI_ET    = 0x08,
    LXB_UNICODE_IDNA_BIDI_ON    = 0x09,
    LXB_UNICODE_IDNA_BIDI_BN    = 0x0A,
    LXB_UNICODE_IDNA_BIDI_NSM   = 0x0B
}
lxb_unicode_idna_bidi_t;

typedef enum {
    LXB_UNICODE_IDNA_JOIN_U = 0x00,
    LXB_UNICODE_IDNA_JOIN_T = 0x01,
    LXB_UNICODE_IDNA_JOIN_L = 0x02,
    LXB_UNICODE_IDNA_JOIN_R = 0x03,
    LXB_UNICODE_IDNA_JOIN_D = 0x04
}
lxb_unicode_idna_join_t;

#define lxb_unicode_idna_props_bidi(p)   ((lxb_unicode_idna_bidi_t) ((p) & 0x0F))
#define lxb_unicode_idna_props_join(p)   ((lxb_unicode_idna_join_t) (((p) >> 4) & 0x07))
#define LXB_UNICODE_IDNA_PROP_VIRAMA     0x0100
#define LXB_UNICODE_IDNA_PROP_MARK       0x0200
