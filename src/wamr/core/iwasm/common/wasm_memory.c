...
static void (*enlarge_memory_success_cb)(WASMModuleInstanceCommon *module_inst,
                                         void *user_data);
static void *enlarge_memory_success_user_data;

void
wasm_runtime_set_enlarge_mem_success_callback(
    void (*callback)(WASMModuleInstanceCommon *module_inst, void *user_data),
    void *user_data)
{
    enlarge_memory_success_cb = callback;
    enlarge_memory_success_user_data = user_data;
}
                             ...
                             WASMMemoryInstance *memory, uint32 inc_page_count)
{
    ...
    if (module && enlarge_memory_success_cb)
        enlarge_memory_success_cb(module, enlarge_memory_success_user_data);
